...
<body data-spy="scroll" data-target="#mainmenu" data-offset="50">
            ...
            <nav class="navbar">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <!--Logo-->
                        <a href="index.html#sc1" class="navbar-left show"><img src="images/rrce-logo.png" alt="library"></a>
                        <div class="space-10"></div>
                    </div>
                    <!--Toggle-button-->
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="index.html#"> <span><i class="icofont icofont-user"></i></span> Profile</a>
                                        </li>
                                        <li>
                                            <a href="index.html#"> <span><i class="icofont icofont-notification"></i></span> Notifications</a>
                                        </li>
                                        <li>
                                            <a href="index.html#"> <span><i class="icofont icofont-settings"></i></span> Settings</a>
                                        </li>
                                        <li>
                                            <a href="index.html#"> <span><i class="icofont icofont-read-book"></i></span>My Books</a>
                                        </li>
                                        <li>
                                            <a href="index.html#"> <span><i class="icofont icofont-logout"></i></span> Log Out</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
            ...
            <div class="container">
                <div class="row wow fadeInUp">
                    <div class="col-xs-12 col-sm-10 col-sm-offset-1 text-center">
                        <div class="jumbotron">
                            <h1 class="text-white">Welcome to Rajarajeswari College of Engineering</h1>
                            <p class="text-white">Computer Science and Engineering Department Library
                                <br/></p>
                        </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="index.html#book">Book</a></li>
                                    <li><a data-toggle="tab" href="index.html#author">Author</a></li>
                                    <li><a data-toggle="tab" href="index.html#publisher">Publisher</a></li>
                                </ul>
                            </div>
                ...
                <div class="col-xs-12">
                    <div class="well single-team">
                        ...
                        <ul class="list-inline list-unstyled social-list">
                            ...
                            <li><a href="index.html#"><i class="icofont icofont-social-behance"></i></a></li>
                            <li><a href="index.html#"><i class="icofont icofont-brand-linkedin"></i></a></li>
                        </ul>
                        <div class="space-20"></div>
                        <div class="title-bar">
                            <ul class="list-inline list-unstyled">
    ...
    <footer class="black-bg text-white">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <a href="index.html#"><img src="images/rrce-logo.png" alt="library"></a>
                    <div class="space-20"></div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut gravida, quam vitae est Sed non eros elementum nulla sodales ullamcorper.</p>
                    <div class="space-10"></div>
                    <ul class="list-inline list-unstyled social-list">
                ...
                <div class="col-xs-12 col-sm-4 col-md-3 col-md-offset-1">
                    ...
                    <table class="table border-none addr-dt">
                        ...
                        <tr>
                            ...
                            <td><a href="http://rrce.org/" target="_blank">www.rrce.org</a></td>
                        </tr>
                    </table>
                </div>
                <div class="col-xs-12 col-sm-4 col-md-3 col-md-offset-1">
